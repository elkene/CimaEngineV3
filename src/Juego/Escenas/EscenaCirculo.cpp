...
#include "Juego/Sistemas/SistemaCirculo.hpp"
#include "Juego/Sistemas/Sistemas.hpp"


namespace IVJ {
    void EscenaCirculo::onInit() {
    ...
    void EscenaCirculo::onFinal(){}
    void EscenaCirculo::onUpdate(float dt) {
        SistemaMovimientoEntes(objetos.getPool(),dt);
        for (auto &f: objetos.getPool())
            f->onUpdate(dt);
        objetos.borrarPool();
    }
    void EscenaCirculo::onInputs(const CE::Botones& accion) {
